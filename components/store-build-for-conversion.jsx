    ...
    return (
        <div className="font-sans">
            ...
            >
                ...
                <div className="lg:h-[345px] flex items-center">
                    <img
                        src="/images/Official_shopify_partner_abu_dhabi_store-build-for-conversion.png"
            ...
            <div
                ...
                >
                    <svg
                        ...
                        fill="#fff"
                        className="w-10 h-10 mb-4 inline-block p-2 rounded-md"
                        style={{ backgroundColor: '#35cbee' }}
                ...
                >
                    <svg
                        ...
                        className="w-10 h-10 mb-4 inline-block p-2 rounded-md"
                        style={{ backgroundColor: '#35cbee' }}
                        viewBox="0 0 176 186.9181299110192"
                    >
